...
class CreateTask:
    ...
    task_name_xpath = "//span[@class='text-ellipsis d-inline-block edit__taskname' and @title='Test Task 101']"
    ...
    def verify_task_name(self):
        locator = (By.XPATH, "//span[@class='text-ellipsis d-inline-block edit__taskname' and @title='Test Task 101']")
